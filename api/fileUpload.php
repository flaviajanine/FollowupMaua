...
$link = $objDb->conecta_mysql();
	...
	$drop = "DROP TABLE IF EXISTS teste" ;
				...
				$create = $create = "CREATE TABLE IF NOT EXISTS teste(id int primary key auto_increment,Exer int,Esc varchar(45),RA_HASH varchar(256),Cur varchar(45),Ser int,Per varchar(45),Fingr varchar(45),StIni varchar(45),StFin   varchar(45),DtSitCur varchar(45),CdDis varchar(45),CurDis varchar(45),SerDis   int,PerDis varchar(45),G int,T int,L int,OriDisc varchar(45),StIniDisc varchar(45),StFinDisc varchar(45),DtStDisc date,SemDisc varchar(45),CritDisc varchar(45),QtTrabalhos int,KT varchar(45),KP varchar(45),P1 varchar(45),P2 varchar(45),PS1 varchar(45),P3 varchar(45),P4 varchar(45),PS2 varchar(45),T1 varchar(45),T2 varchar(45),T3 varchar(45),T4 varchar(45),T5 varchar(45),T6 varchar(45),T7 varchar(45),T8 varchar(45),T9 varchar(45),T10 varchar(45),T11 varchar(45),T12 varchar(45),T13 varchar(45),T14 varchar(45),T15 varchar(45),T16 varchar(45),MT varchar(45),MP varchar(45),MF varchar(45),Aprovado varchar(45),Acuracia varchar(45))";
